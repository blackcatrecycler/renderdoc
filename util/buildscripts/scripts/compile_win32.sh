...
if [ ! -f ./Win32/Release/blacatdoc.dll ] || [ ! -f ./Win32/Release/blacatdocui.exe ] || [ ! -f ./Win32/Release/blacatdoccmd.exe ] ; then
...
if [ ! -f ./x64/Release/blacatdoc.dll ] || [ ! -f ./x64/Release/blacatdocui.exe ] || [ ! -f ./x64/Release/blacatdoccmd.exe ] ; then
