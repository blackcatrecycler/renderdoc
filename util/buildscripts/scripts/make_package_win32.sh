...
if ls build-android-* > /dev/null; then
	find build-android-* -iname 'org.blacatdoc.blacatdoccmd.*.apk' -exec cp '{}' dist/Release64/plugins/android ';'
else
...
cp -R dist/Release32/{d3dcompiler_47.dll,blacatdoc.dll,blacatdoc.json,blacatdocshim32.dll,blacatdoccmd.exe,dbghelp.dll,symsrv.dll,symsrv.yes} dist/Release64/x86/
mkdir -p dist/ReleasePDBs64/x86
cp -R dist/ReleasePDBs32/{d3dcompiler_47.dll,blacatdoc.dll,blacatdoc.json,blacatdoc.pdb,blacatdocshim32.dll,blacatdocshim32.pdb,blacatdoccmd.exe,blacatdoccmd.pdb,dbghelp.dll,symsrv.dll,symsrv.yes} dist/ReleasePDBs64/x86/
